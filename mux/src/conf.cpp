...
void cf_init(void)
{
    ...
    mudconf.guest_file     = StringClone(T("/home/tinymux/TinyMUX/mux/game/text/guest.txt"));
    mudconf.conn_file      = StringClone(T("/home/tinymux/TinyMUX/mux/game/text/connect.txt"));
    mudconf.creg_file      = StringClone(T("/home/tinymux/TinyMUX/mux/game/text/register.txt"));
    mudconf.regf_file      = StringClone(T("/home/tinymux/TinyMUX/mux/game/text/create_reg.txt"));
    mudconf.motd_file      = StringClone(T("/home/tinymux/TinyMUX/mux/game/text/motd.txt"));
    mudconf.wizmotd_file   = StringClone(T("/home/tinymux/TinyMUX/mux/game/text/wizmotd.txt"));
    mudconf.quit_file      = StringClone(T("/home/tinymux/TinyMUX/mux/game/text/quit.txt"));
    mudconf.down_file      = StringClone(T("/home/tinymux/TinyMUX/mux/game/text/down.txt"));
    mudconf.full_file      = StringClone(T("/home/tinymux/TinyMUX/mux/game/text/full.txt"));
    mudconf.site_file      = StringClone(T("/home/tinymux/TinyMUX/mux/game/text/badsite.txt"));
    mudconf.crea_file      = StringClone(T("/home/tinymux/TinyMUX/mux/game/text/newuser.txt"));
